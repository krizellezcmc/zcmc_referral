...
function TaguForNurse(props) {
  ...
  const fetchData = async () => {
    ...
    // if (response && meds && bfeed) {
    //   setIsLoading(false);
    // }
  };
  function generateTagu() {
    navigate(`/tagubilinreport/${props.id}`);
  }
