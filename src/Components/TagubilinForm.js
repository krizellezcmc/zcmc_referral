...
function TagubilinForm(props) {
  ...
  useEffect(() => {
    ...
    const fetchTagu = async () => {
      let tagu = await api.get("/get_tagubilinId.php");
      setTaguId(tagu.data);
      // let tagu = await api.get("/check_tagu.php", {
      //   params: { id: patRegister },
      // });
      console.log(tagu.data);
    };
  ...
  return (
    ...
    >
      ...
      <Tr>
        ...
        taguId.map((t, k) => {
          return t.PK_tagubilinId === patRegister ? (
            <TaguForNurse id={props.id} />
          ) : (
            <TableContainer>
              <form onSubmit={submit}>
                <Table variant="unstyled" cellSpacing={0}>
                  <Tbody>
                    ...
                    <Tr>
                      <Td className="border" colSpan="5" m={0} py={1}>
                        <Text fontSize="12px" fontWeight="600">
                          Major Diagnostic Results/Pangunahing Resulta ng
                          Pagsusuri
                        </Text>
                      </Td>
                    </Tr>
                          ...
                          <Grid templateColumns="repeat(6, 1fr)" gap={4} mt={3}>
                            ...
                            >
                              ...
                              <Textarea
                                ...
                                fontSize="14px"
                                onChange={(e) =>
                                  setHealthOthers(e.target.value)
                                }
                              ></Textarea>
                            </GridItem>
                          </Grid>
                    ...
                    <Tr>
                      <Td className="border" colSpan="5">
                        ...
                        <Text mt={5} fontStyle="italic" fontSize="13.5px">
                          ...
                          for Globe and 09533296357 for TM during office hours
                          Monday to Saturday, 8am to 5pm or email us at <br />
                          records@zcmc.doh.gov.ph and we will happy to serve
                          you.
                        </Text>
                      </Td>
                    </Tr>
                    ...
                    <Tr>
                      ...
                      >
                        <HStack>
                          <Text fontSize="12px" fontWeight="600">
                            I understand the above explanation given, I do
                            hereby agree that I will have follow-up checkup:
                          </Text>
                          <Box
                            style={{
                              width: "350px",
